...
import fmt "fmt"
import math "math"
import _ "github.com/mhconradt/proto/conversation"
...
func (m *User) ToORM(ctx context.Context) (UserORM, error) {
	...
	if m.LastActive != nil {
		var t time.Time
		if t, err = ptypes1.Timestamp(m.LastActive); err != nil {
			return to, err
		}
		to.LastActive = &t
	}
...
func (m *UserORM) ToPB(ctx context.Context) (User, error) {
	...
	if m.LastActive != nil {
		if to.LastActive, err = ptypes1.TimestampProto(*m.LastActive); err != nil {
			return to, err
		}
	}
	to.Username = m.Username
